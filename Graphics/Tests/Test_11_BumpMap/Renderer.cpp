...
Renderer::Renderer(Window &parent) : OGLRenderer(parent) {
	camera = new Camera();
	heightMap = new HeightMap(TEXTUREDIR"HeightMapMedium.raw");
	...
	lightShader   = new Shader(SHADERDIR"PerPixelVertex.glsl",   SHADERDIR"MultiTexPerPixelFragment.glsl");
	grassShader   = new Shader(SHADERDIR"GrassBladeVertex.glsl", SHADERDIR"GrassBladeFragment.glsl");
