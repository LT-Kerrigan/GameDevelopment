...
Renderer::Renderer(Window &parent) : OGLRenderer(parent) {
	...
	meshes[0]->SetTexture(SOIL_load_OGL_texture(TEXTUREDIR"rusted_down.jpeg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, 0));
...
void Renderer::RenderScene(){
	...
	glUniformMatrix4fv(glGetUniformLocation(currentShader->GetProgram(), "projMatrix"), 1, false, (float*)&viewMatrix);
