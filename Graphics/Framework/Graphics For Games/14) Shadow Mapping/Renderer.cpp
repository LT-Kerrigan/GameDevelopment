...
Renderer::Renderer(Window &parent) : OGLRenderer(parent){
	...
	sceneShader  = new Shader("../../Shaders/ShadowSceneVertex.glsl", "../../Shaders/ShadowSceneFrag.glsl");
	shadowShader = new Shader("../../Shaders/ShadowVertex.glsl", "../../Shaders/ShadowFrag.glsl");
