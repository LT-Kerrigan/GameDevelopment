...
*	::::::-:.`'..`'.:-::::::			@link								               *
*	::::::::\ `--' /::::::::			@detail	Camera class sanity check on pitch and yaw *
*																						   *
********************************************************************************************/
...
void Camera::UpdateCamera(float msec){
	...
	//form a rotation matrix (yaw) * direction vector pointing down the -z 
	//in order to rotate in the direction the camera is facing
