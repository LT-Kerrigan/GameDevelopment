...
Renderer::Renderer(Window &parent) : OGLRenderer(parent) {
	...
	sceneShader = new Shader("../../Shaders/BumpVertex.glsl", "../../Shaders/BufferFrag.glsl");
	if (!sceneShader->LinkProgram()) {
		return;
	}

	pointlightShader = new Shader("../../Shaders/PointLightVertex.glsl", "../../Shaders/PointLightFrag.glsl");
	if (!pointlightShader->LinkProgram()){
		return;
	}

	combineShader = new Shader("../../Shaders/CombineVertex.glsl", "../../Shaders/CombineFrag.glsl");
