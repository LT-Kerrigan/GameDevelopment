...
ParticleEmitter::ParticleEmitter(void)	{
	...
	*/
	...
	m_Texture = SOIL_load_OGL_texture(TEXTUREDIR"symbol_wood.png",
		SOIL_LOAD_AUTO,SOIL_CREATE_NEW_ID,SOIL_FLAG_COMPRESS_TO_DXT);
}
...
void	ParticleEmitter::ResizeArrays() {
	...
	glDeleteBuffers(1, &m_BufferObject[VERTEX_BUFFER]);
	glDeleteBuffers(1, &m_BufferObject[COLOUR_BUFFER]);
