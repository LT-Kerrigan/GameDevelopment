...
Renderer::Renderer(Window &parent) : OGLRenderer(parent) {
	...
	sceneShader = new Shader(SHADERDIR"Test_14_ShadowSceneVertex.glsl", SHADERDIR"Test_14_ShadowSceneFrag.glsl");
	shadowShader = new Shader(SHADERDIR"Test_14_ShadowVertex.glsl", SHADERDIR"Test_14_ShadowFrag.glsl");
